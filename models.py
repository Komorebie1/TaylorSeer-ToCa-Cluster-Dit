...
class DiTBlock(nn.Module):
    ...
    def forward(self, x, c, current, cache_dic):
        ...
        elif current['type'] == 'Taylor+ToCa':  # Partial Computation: Compute only fresh tokens and save them in cache, no attention token computation in the final version
